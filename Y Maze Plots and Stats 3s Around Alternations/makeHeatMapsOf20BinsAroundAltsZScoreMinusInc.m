...
spikeRatesBinned6412 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6412IncorrectAlts.mat').binnedSpikeRateAroundAlts;
spikeRatesBinned6416 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6416IncorrectAlts.mat').binnedSpikeRateAroundAlts;
spikeRatesBinned6417 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6417IncorrectAlts.mat').binnedSpikeRateAroundAlts;
spikeRatesBinned6431 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6431IncorrectAlts.mat').binnedSpikeRateAroundAlts;
...
meanMinusIncorAltResp = smoothdata(mean(minusIncAltResp,1),'movmean',5);
stdMinusIncorAltResp = std(minusIncAltResp,0,1)./sqrt(height(minusIncAltResp));

meanMinusIncorAltUnresp = smoothdata(mean(minusIncAltUnresp,1),'movmean',5);
stdMinusIncorAltUnresp = std(minusIncAltUnresp,0,1)./sqrt(height(minusIncAltUnresp));

%% make array for responsive minus unresponsive and plot
xx= 1:numel(meanMinusIncorAltResp);
meanMinusIncorRespMinusUnresp = meanMinusIncorAltResp-meanMinusIncorAltUnresp;
plot(xx,meanMinusIncorRespMinusUnresp);
...
save("minusIncorMeanMinusIncRespMinusUnresp","meanMinusIncorRespMinusUnresp");
...
meanMinusIncorAltResp = transpose(meanMinusIncorAltResp);
stdMinusIncorAltResp = transpose(stdMinusIncorAltResp);
meanMinusIncorAltUnresp = transpose(meanMinusIncorAltUnresp);
stdMinusIncorAltUnresp = transpose(stdMinusIncorAltUnresp);


stdMinusIncTable = table(meanMinusIncorAltResp,stdMinusIncorAltResp,meanMinusIncorAltUnresp,stdMinusIncorAltUnresp);

writetable(stdMinusIncTable,'stdMinusIncTable.csv')
