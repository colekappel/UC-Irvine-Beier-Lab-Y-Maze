...
%    plusOrMinusString,mouseString)


%% 5x+ 
spikeRateMatx6025 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6025.csv'),'6025CorrectAlts',...
    times6025,startFrame6025,1,"6025",1,15);

spikeRateMatx6026 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6026.csv'),'6026CorrectAlts',...
    times6026,startFrame6026,1,"6026",1,15);

spikeRateMatx6027 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6027.csv'),'6027CorrectAlts',...
    times6027,startFrame6027,1,"6027",1,15);

spikeRateMatx6028 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6028.csv'),'6028CorrectAlts',...
    times6028,startFrame6028,1,"6028",1,15);

spikeRateMatx6029 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6029.csv'),'6029CorrectAlts',...
    times6029,startFrame6029,1,"6029",1,15);

%% 5x-
spikeRateMatx6039 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6039.csv'),'6039CorrectAlts',...
    times6039,startFrame6039,1,"6039",-1,15);

spikeRateMatx6041 = getSpikesAroundAltsZScore(readtable('SpontAlt/spikes6041.csv'),'6041CorrectAlts',...
    times6041,startFrame6041,1,"6041",-1,15);

%% new 5x- mice 
spikeRateMatx6412 = getSpikesAroundAltsZScore(readtable('SpontAlt/events_6412_first.csv'),'6412CorrectAlts',...
    times6412,startFrame6412,1,"6412",-1,28.29);

spikeRateMatx6416 = getSpikesAroundAltsZScore(readtable('SpontAlt/events_6416_2nd.csv'),'6416CorrectAlts',...
    times6416_2,startFrame6416_2,1,"6416",-1,27.66);

spikeRateMatx6417 = getSpikesAroundAltsZScore(readtable('SpontAlt/events_6417_first.csv'),'6417CorrectAlts',...
    times6417,startFrame6417,1,"6417",-1,28.77);

spikeRateMatx6431 = getSpikesAroundAltsZScore(readtable('SpontAlt/events_6431.csv'),'6431CorrectAlts',...
