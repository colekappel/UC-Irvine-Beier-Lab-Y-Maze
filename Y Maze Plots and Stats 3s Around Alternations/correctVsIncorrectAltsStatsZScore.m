...
correctLmeMinus = load('CorrectAltsStats/lmeTables.mat').lme5xMinus;
correctLmePlus = load('CorrectAltsStats/lmeTables.mat').lme5xPlus;

incorrectLmeMinus = load('IncorrectAltsStats/lmeTables.mat').lme5xMinus;
incorrectLmePlus = load('IncorrectAltsStats/lmeTables.mat').lme5xPlus;
...
ylabel('Z Scored Event Rate','FontSize',14)
...
save('corAndIncLmes.mat','correctLmeMinus','correctLmePlus','incorrectLmeMinus','incorrectLmePlus');