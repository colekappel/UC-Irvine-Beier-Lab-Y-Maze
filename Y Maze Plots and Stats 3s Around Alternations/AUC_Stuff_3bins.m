...
%% make bar charts: 
y = [av_AUC_PlusCorRespneg3toneg1 av_AUC_PlusCorRespneg1to0 av_AUC_PlusCorResp0to3;...
    av_AUC_PlusIncRespneg3toneg1 av_AUC_PlusIncRespneg1to0 av_AUC_PlusIncResp0to3;...
    av_AUC_MinusCorRespneg3toneg1 av_AUC_MinusCorRespneg1to0 av_AUC_MinusCorResp0to3;...
    av_AUC_MinusIncRespneg3toneg1 av_AUC_MinusIncRespneg1to0 av_AUC_MinusIncResp0to3];
...
xx_csv=[AUC_PlusCorRespneg3toneg1,AUC_PlusCorRespneg1to0,AUC_PlusCorResp0to3,...
    AUC_PlusIncRespneg3toneg1,AUC_PlusIncRespneg1to0,AUC_PlusIncResp0to3,...
    (AUC_MinusCorRespneg3toneg1 ),(AUC_MinusCorRespneg1to0 ),(AUC_MinusCorResp0to3),...
    (AUC_MinusIncRespneg3toneg1), (AUC_MinusIncRespneg1to0), (AUC_MinusIncResp0to3)];
