...
circShuff6025 = load('CircShuffDataZScore/spontAltCircShuff6025CorrectAlts.mat').spikeRateMatx;
circShuff6026 = load('CircShuffDataZScore/spontAltCircShuff6026CorrectAlts.mat').spikeRateMatx;
circShuff6027 = load('CircShuffDataZScore/spontAltCircShuff6027CorrectAlts.mat').spikeRateMatx;
circShuff6028 = load('CircShuffDataZScore/spontAltCircShuff6028CorrectAlts.mat').spikeRateMatx;
circShuff6029 = load('CircShuffDataZScore/spontAltCircShuff6029CorrectAlts.mat').spikeRateMatx;

plusCircShuff = [circShuff6025;circShuff6026;circShuff6027;circShuff6028;circShuff6029];

%% spike rate matrices 5x+
spikeRates6025 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6025CorrectAlts.mat').spikeRate;
spikeRates6026 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6026CorrectAlts.mat').spikeRate;
spikeRates6027 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6027CorrectAlts.mat').spikeRate;
spikeRates6028 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6028CorrectAlts.mat').spikeRate;
spikeRates6029 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6029CorrectAlts.mat').spikeRate;

plusSpikeRates = [spikeRates6025;spikeRates6026;spikeRates6027;spikeRates6028;spikeRates6029];

%% lme tables 5x+ 
lme6025 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6025CorrectAlts.mat').lmeTable;
lme6026 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6026CorrectAlts.mat').lmeTable;
lme6027 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6027CorrectAlts.mat').lmeTable;
lme6028 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6028CorrectAlts.mat').lmeTable;
lme6029 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6029CorrectAlts.mat').lmeTable;
...
%% 5x-: 6039, 6041
%% circular shuffle stuff: 5x-
circShuff6039 = load('CircShuffDataZScore/spontAltCircShuff6039CorrectAlts.mat').spikeRateMatx;
circShuff6041 = load('CircShuffDataZScore/spontAltCircShuff6041CorrectAlts.mat').spikeRateMatx;

circShuff6412 = load('CircShuffDataZScore/spontAltCircShuff6412CorrectAlts.mat').spikeRateMatx;
circShuff6416 = load('CircShuffDataZScore/spontAltCircShuff6416CorrectAlts.mat').spikeRateMatx;
circShuff6417 = load('CircShuffDataZScore/spontAltCircShuff6417CorrectAlts.mat').spikeRateMatx;
circShuff6431 = load('CircShuffDataZScore/spontAltCircShuff6431CorrectAlts.mat').spikeRateMatx;

minusCircShuff = [circShuff6039; circShuff6041;circShuff6412;circShuff6416;circShuff6417;circShuff6431];

%% spike rate matrices 5x-
spikeRates6039 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6039CorrectAlts.mat').spikeRate;
spikeRates6041 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6041CorrectAlts.mat').spikeRate;

spikeRates6412 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6412CorrectAlts.mat').spikeRate;
spikeRates6416 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6416CorrectAlts.mat').spikeRate;
spikeRates6417 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6417CorrectAlts.mat').spikeRate;
spikeRates6431 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6431CorrectAlts.mat').spikeRate;

minusSpikeRates = [spikeRates6039;spikeRates6041;spikeRates6412;spikeRates6416;spikeRates6417;spikeRates6431];

%% lme tables 5x-
lme6039 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6039CorrectAlts.mat').lmeTable;
lme6041 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6041CorrectAlts.mat').lmeTable;

lme6412 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6412CorrectAlts.mat').lmeTable;
lme6416 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6416CorrectAlts.mat').lmeTable;
lme6417 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6417CorrectAlts.mat').lmeTable;
lme6431 = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6431CorrectAlts.mat').lmeTable;
...
responsivePlus = load('CorVIncResponsiveness1sUnZScoredW6412_1stSesh/Correct.mat').responsivePlus;
responsiveMinus = load('CorVIncResponsiveness1sUnZScoredW6412_1stSesh/Correct.mat').responsiveMinus;
...
hold on
cdfplot(lme5xPlus{:,1});
title('5x+ vs 5x-: CDF for Correct Alternations Z scored','FontSize',14)
...
title('5x+ vs 5x-: Z Scored Spike Rate Comparison for Correct Alternations Z scored','FontSize',20)
...
title('Z Scored Spike Rate Comparison Around Correct Alternations: All Mice Included','FontSize',24)
...
title('5x Plus')
title(t,'Correct Alternations Z scored','FontSize',32,'FontWeight','Bold')
...
title('Z Scored Spike Rate Comparison for Correct Alternations','FontSize',20)
ylabel('Event Rate','FontSize',14)
...
save('CorVIncResponsiveness/Correct',"responsiveArrMinus","responsiveArrPlus","rPlus","rMinus");
...
save('ResponsiveRowsCorrectZScore.mat',"rMinus","rPlus")

save('corLMEs.mat','lme5xMinus','lme5xPlus','rMinus','rPlus');