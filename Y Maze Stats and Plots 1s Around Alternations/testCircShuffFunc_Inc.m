...
spikeRateMatx6025 = circShuff(readtable('SpontAlt/spikes6025.csv'),'6025IncorrectAlts',...
    times6025_inc,startFrame6025,15);

spikeRateMatx6026 = circShuff(readtable('SpontAlt/spikes6026.csv'),'6026IncorrectAlts',...
    times6026_inc,startFrame6026,15);

spikeRateMatx6027 = circShuff(readtable('SpontAlt/spikes6027.csv'),'6027IncorrectAlts',...
    times6027_inc,startFrame6027,15);

spikeRateMatx6028 = circShuff(readtable('SpontAlt/spikes6028.csv'),'6028IncorrectAlts',...
    times6028_inc,startFrame6028,15);

spikeRateMatx6029 = circShuff(readtable('SpontAlt/spikes6029.csv'),'6029IncorrectAlts',...
    times6029_inc,startFrame6029,15);

spikeRateMatx6039 = circShuff(readtable('SpontAlt/spikes6039.csv'),'6039IncorrectAlts',...
    times6039_inc,startFrame6039,15);

spikeRateMatx6041 = circShuff(readtable('SpontAlt/spikes6041.csv'),'6041IncorrectAlts',...
    times6041_inc,startFrame6041,15);

%% new mice 

spikeRateMatx6412 = circShuff(readtable('SpontAlt/events_6412_first.csv'),'6412IncorrectAlts',...
    times6412_inc,startFrame6412,28.29);

spikeRateMatx6416 = circShuff(readtable('SpontAlt/events_6416_2nd.csv'),'6416IncorrectAlts',...
    times6416_inc_2,startFrame6416_2,27.66);

spikeRateMatx6417 = circShuff(readtable('SpontAlt/events_6417_first.csv'),'6417IncorrectAlts',...
    times6417_inc,startFrame6417,28.77);

spikeRateMatx6431 = circShuff(readtable('SpontAlt/events_6431.csv'),'6431IncorrectAlts',...
