...
circShuff6025 = load('CircShuffData/spontAltCircShuff6025IncorrectAlts.mat').spikeRateMatx;
circShuff6026 = load('CircShuffData/spontAltCircShuff6026IncorrectAlts.mat').spikeRateMatx;
circShuff6027 = load('CircShuffData/spontAltCircShuff6027IncorrectAlts.mat').spikeRateMatx;
circShuff6028 = load('CircShuffData/spontAltCircShuff6028IncorrectAlts.mat').spikeRateMatx;
circShuff6029 = load('CircShuffData/spontAltCircShuff6029IncorrectAlts.mat').spikeRateMatx;

plusCircShuff = [circShuff6025;circShuff6026;circShuff6027;circShuff6028;circShuff6029];

writematrix(plusCircShuff,'plusCircShuff_inc.csv');

%% spike rate matrices 5x+
spikeRates6025 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6025IncorrectAlts.mat').spikeRate;
spikeRates6026 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6026IncorrectAlts.mat').spikeRate;
spikeRates6027 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6027IncorrectAlts.mat').spikeRate;
spikeRates6028 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6028IncorrectAlts.mat').spikeRate;
spikeRates6029 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6029IncorrectAlts.mat').spikeRate;

plusSpikeRates = [spikeRates6025;spikeRates6026;spikeRates6027;spikeRates6028;spikeRates6029];

%% lme tables 5x+ 
lme6025 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6025IncorrectAlts.mat').lmeTable;
lme6026 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6026IncorrectAlts.mat').lmeTable;
lme6027 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6027IncorrectAlts.mat').lmeTable;
lme6028 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6028IncorrectAlts.mat').lmeTable;
lme6029 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6029IncorrectAlts.mat').lmeTable;
...
%% 5x-: 6039, 6041
%% circular shuffle stuff: 5x-
circShuff6039 = load('CircShuffData/spontAltCircShuff6039IncorrectAlts.mat').spikeRateMatx;
circShuff6041 = load('CircShuffData/spontAltCircShuff6041IncorrectAlts.mat').spikeRateMatx;

circShuff6412 = load('CircShuffData/spontAltCircShuff6412IncorrectAlts.mat').spikeRateMatx;
circShuff6416 = load('CircShuffData/spontAltCircShuff6416IncorrectAlts.mat').spikeRateMatx;
circShuff6417 = load('CircShuffData/spontAltCircShuff6417IncorrectAlts.mat').spikeRateMatx;
circShuff6431 = load('CircShuffData/spontAltCircShuff6431IncorrectAlts.mat').spikeRateMatx;

minusCircShuff = [circShuff6039; circShuff6041;circShuff6412;circShuff6416;circShuff6417;circShuff6431];

writematrix(minusCircShuff,'minusCircShuff_inc.csv');

%% spike rate matrices 5x-
spikeRates6039 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6039IncorrectAlts.mat').spikeRate;
spikeRates6041 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6041IncorrectAlts.mat').spikeRate;

spikeRates6412 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6412IncorrectAlts.mat').spikeRate;
spikeRates6416 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6416IncorrectAlts.mat').spikeRate;
spikeRates6417 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6417IncorrectAlts.mat').spikeRate;
spikeRates6431 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6431IncorrectAlts.mat').spikeRate;

minusSpikeRates = [spikeRates6039;spikeRates6041;spikeRates6412;spikeRates6416;spikeRates6417;spikeRates6431];

%% lme tables 5x-
lme6039 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6039IncorrectAlts.mat').lmeTable;
lme6041 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6041IncorrectAlts.mat').lmeTable;

lme6412 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6412IncorrectAlts.mat').lmeTable;
lme6416 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6416IncorrectAlts.mat').lmeTable;
lme6417 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6417IncorrectAlts.mat').lmeTable;
lme6431 = load('SpontAltSpikesAroundAlts/spikesAroundAlts6431IncorrectAlts.mat').lmeTable;
...
hold on
cdfplot(lme5xPlus{:,1});
title('5x+ vs 5x-: CDF for Incorrect Alternations ','FontSize',14)
...
title('5x+ vs 5x-:  Spike Rate Comparison for Incorrect Alternations','FontSize',20)
...
xlabel(' Spike Rate (Hz)','FontSize',20)
ylabel('Probability','FontSize',20)
title(' Spike Rate Comparison Around Incorrect Alternations: All Mice Included','FontSize',24)
...
title('5x Plus')
title(t,'Incorrect Alternations ','FontSize',32,'FontWeight','Bold')
...
title(' Spike Rate Comparison for Incorrect Alternations','FontSize',20)
ylabel('Event Rate','FontSize',14)
...
%}
save('CorVIncResponsiveness/Incorrect',"responsiveArrMinus","responsiveArrPlus",...
...
save('ResponsiveRowsIncorrect.mat',"rMinus","rPlus")

save('responsivenessIncorrect.mat','lme5xMinus','lme5xPlus')
