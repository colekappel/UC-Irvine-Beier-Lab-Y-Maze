...
responsivePlus = load('CorVIncResponsiveness1sUnZScored/Correct.mat').responsivePlus;
responsiveMinus = load('CorVIncResponsiveness1sUnZScored/Correct.mat').responsiveMinus;
