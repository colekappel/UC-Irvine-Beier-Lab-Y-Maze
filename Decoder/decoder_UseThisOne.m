...
%% 6025 Correct: 
srEachTurn6025Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6025CorrectAlts.mat').srForEachTurn;

%% 6025 Incorrect: 
srEachTurn6025Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6025IncorrectAlts.mat').srForEachTurn;

%% 6027 Correct: 
srEachTurn6027Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6027CorrectAlts.mat').srForEachTurn;

%% 6027 Incorrect: 
srEachTurn6027Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6027IncorrectAlts.mat').srForEachTurn;

%% 6041 Correct: 
srEachTurn6041Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6041CorrectAlts.mat').srForEachTurn;

%% 6041 Incorrect: 
srEachTurn6041Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6041IncorrectAlts.mat').srForEachTurn;

%% More mice: 

%% 6026 Correct: 
srEachTurn6026Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6026CorrectAlts.mat').srForEachTurn;

%% 6026 Incorrect: 
srEachTurn6026Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6026IncorrectAlts.mat').srForEachTurn;

%% 6028 Correct: 
srEachTurn6028Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6028CorrectAlts.mat').srForEachTurn;

%% 6028 Incorrect: 
srEachTurn6028Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6028IncorrectAlts.mat').srForEachTurn;

%% 6029 Correct: 
srEachTurn6029Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6029CorrectAlts.mat').srForEachTurn;

%% 6029 Incorrect: 
srEachTurn6029Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6029IncorrectAlts.mat').srForEachTurn;

%% 6039 Correct: 
srEachTurn6039Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6039CorrectAlts.mat').srForEachTurn;

%% 6039 Incorrect: 
srEachTurn6039Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6039IncorrectAlts.mat').srForEachTurn;

%% new mice to add: 6412, 6416, 6417, 6431

%% 6412 Correct
srEachTurn6412Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6412CorrectAlts.mat').srForEachTurn;

%% 6412 Incorrect
srEachTurn6412Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6412IncorrectAlts.mat').srForEachTurn;

%% 6416 Correct 
srEachTurn6416Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6416CorrectAlts.mat').srForEachTurn;

%% 6416 Incorrect 
srEachTurn6416Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6416IncorrectAlts.mat').srForEachTurn;

%% 6417 Correct 
srEachTurn6417Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6417CorrectAlts.mat').srForEachTurn;

%% 6417 Incorrect 
srEachTurn6417Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6417IncorrectAlts.mat').srForEachTurn;

%% 6431 Correct 
srEachTurn6431Cor = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6431CorrectAlts.mat').srForEachTurn;

%% 6431 Incorrect 
srEachTurn6431Inc = load('SpontAltSpikesAroundAltsZScore/spikesAroundAlts6431IncorrectAlts.mat').srForEachTurn;
...
save('allVariablesFromDecoderAnalysis_newRun');
