...
lme6025_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6025CorrectAlts.mat').lmeTable;
lme6026_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6026CorrectAlts.mat').lmeTable;
lme6027_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6027CorrectAlts.mat').lmeTable;
lme6028_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6028CorrectAlts.mat').lmeTable;
lme6029_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6029CorrectAlts.mat').lmeTable;

lme5xPlus_cor = [lme6025_cor;lme6026_cor;lme6027_cor;lme6028_cor;lme6029_cor];

lme6025_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6025IncorrectAlts.mat').lmeTable;
lme6026_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6026IncorrectAlts.mat').lmeTable;
lme6027_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6027IncorrectAlts.mat').lmeTable;
lme6028_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6028IncorrectAlts.mat').lmeTable;
lme6029_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6029IncorrectAlts.mat').lmeTable;

lme5xPlus_inc = [lme6025_inc;lme6026_inc;lme6027_inc;lme6028_inc;lme6029_inc];

%% 5x- mice:

lme6039_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6039CorrectAlts.mat').lmeTable;
lme6041_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6041CorrectAlts.mat').lmeTable;

lme6412_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6412CorrectAlts.mat').lmeTable;
lme6416_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6416CorrectAlts.mat').lmeTable;
lme6417_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6417CorrectAlts.mat').lmeTable;
lme6431_cor = load('SpontAltSpikesAroundAlts/spikesAroundAlts6431CorrectAlts.mat').lmeTable;

lme5xMinus_cor = [lme6039_cor;lme6041_cor;lme6412_cor;lme6416_cor;lme6417_cor;lme6431_cor];

lme6039_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6039IncorrectAlts.mat').lmeTable;
lme6041_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6041IncorrectAlts.mat').lmeTable;

lme6412_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6412IncorrectAlts.mat').lmeTable;
lme6416_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6416IncorrectAlts.mat').lmeTable;
lme6417_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6417IncorrectAlts.mat').lmeTable;
lme6431_inc = load('SpontAltSpikesAroundAlts/spikesAroundAlts6431IncorrectAlts.mat').lmeTable;
...
fiveXMinusIncRespRows = load('CorVIncResponsiveness/Incorrect').rMinus;
...
for i =1:NumNeurons  % change to 1:NumNeurons
    AUC_PlusCorRespneg3toneg1(i) = (sum(plusCorAltResp(i,1:20))/20)*2;
    AUC_PlusCorRespneg1to0(i) = (sum(plusCorAltResp(i,21:30))/10)*1;
    AUC_PlusCorResp0to3(i) = (sum(plusCorAltResp(i,31:end))/30)*3;
...
for i =1:NumNeurons  % change to 1:NumNeurons
    AUC_PlusIncRespneg3toneg1(i) = (sum(plusIncAltResp(i,1:20))/20)*2;
    AUC_PlusIncRespneg1to0(i) = (sum(plusIncAltResp(i,21:30))/10)*1;
    AUC_PlusIncResp0to3(i) = (sum(plusIncAltResp(i,31:end))/30)*3;
...
for i =1:NumNeurons  % change to 1:NumNeurons
    AUC_MinusCorRespneg3toneg1(i) = (sum(minusCorAltResp(i,1:20))/20)*2;
    AUC_MinusCorRespneg1to0(i) = (sum(minusCorAltResp(i,21:30))/10)*1;
    AUC_MinusCorResp0to3(i) = (sum(minusCorAltResp(i,31:end))/30)*3;
...
for i =1:NumNeurons  % change to 1:NumNeurons
    AUC_MinusIncRespneg3toneg1(i) = (sum(minusIncAltResp(i,1:20))/20)*2;
    AUC_MinusIncRespneg1to0(i) = (sum(minusIncAltResp(i,21:30))/10)*1;
    AUC_MinusIncResp0to3(i) = (sum(minusIncAltResp(i,31:end))/30)*3;
...
xx=[AUC_PlusCorRespneg3toneg1/2,AUC_PlusCorRespneg1to0,AUC_PlusCorResp0to3/3,...
...
figure;
subplot(2,1,1)
hCorAltResp = heatmap(minusCorAltResp,'Colormap',abyss,'CellLabelColor','none');
grid off
title('5x- Correct Alternation: Responsive ')
ylabel('cell')
hCorAltResp.FontSize=14;
...
subplot(2,1,2)
hCorAltUnresp = heatmap(minusCorAltUnresp,'Colormap',copper,'CellLabelColor','none');
grid off 
title('5x- Correct Alternation: Unresponsive ')
ylabel('cell')
hCorAltUnresp.FontSize=14;
...
figure;
subplot(2,1,1)
hIncorAltResp = heatmap(minusIncAltResp,'Colormap',abyss,'CellLabelColor','none');
grid off
title('5x- Incorrect Alternation: Responsive ')
ylabel('cell')
hIncorAltResp.FontSize=14;
...
subplot(2,1,2)
hIncorAltUnresp = heatmap(minusIncAltUnresp,'Colormap',copper,'CellLabelColor','none');
grid off 
title('5x- Incorrect Alternation: Unresponsive ')
ylabel('cell')
hIncorAltUnresp.FontSize=14;
...
figure;
subplot(2,1,1)
hCor=heatmap(minusCorAltResp,'Colormap',abyss,'CellLabelColor','none');
grid off
title('5x- Correct Alternation: Responsive ')
ylabel('cell')
hCor.FontSize=14;
...
subplot(2,1,2)
hInc = heatmap(minusIncAltResp,'Colormap',abyss,'CellLabelColor','none');
grid off
title('5x- Incorrect Alternation: Responsive ')
ylabel('cell')
xlabel('1/10th second bins around alternation (alternation occurs in middle)')
