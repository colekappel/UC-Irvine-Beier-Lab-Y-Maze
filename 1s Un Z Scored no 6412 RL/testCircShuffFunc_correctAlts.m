...
spikeRateMatx6025 = circShuff(readtable('SpontAlt/spikes6025.csv'),'6025CorrectAlts',...
    times6025,startFrame6025,15);

spikeRateMatx6026 = circShuff(readtable('SpontAlt/spikes6026.csv'),'6026CorrectAlts',...
    times6026,startFrame6026,15);

spikeRateMatx6027 = circShuff(readtable('SpontAlt/spikes6027.csv'),'6027CorrectAlts',...
    times6027,startFrame6027,15);

spikeRateMatx6028 = circShuff(readtable('SpontAlt/spikes6028.csv'),'6028CorrectAlts',...
    times6028,startFrame6028,15);

spikeRateMatx6029 = circShuff(readtable('SpontAlt/spikes6029.csv'),'6029CorrectAlts',...
    times6029,startFrame6029,15);

%% minus mice
spikeRateMatx6039 = circShuff(readtable('SpontAlt/spikes6039.csv'),'6039CorrectAlts',...
    times6039,startFrame6039,15);

spikeRateMatx6041 = circShuff(readtable('SpontAlt/spikes6041.csv'),'6041CorrectAlts',...
    times6041,startFrame6041,15);

%% new mice 

spikeRateMatx6412 = circShuff(readtable('SpontAlt/events_6412_2nd.csv'),'6412CorrectAlts',...
    times6412_2,startFrame6412_2,28.29);

spikeRateMatx6416 = circShuff(readtable('SpontAlt/events_6416_2nd.csv'),'6416CorrectAlts',...
    times6416_2,startFrame6416_2,27.66);

spikeRateMatx6417 = circShuff(readtable('SpontAlt/events_6417_first.csv'),'6417CorrectAlts',...
    times6417,startFrame6417,28.77);

spikeRateMatx6431 = circShuff(readtable('SpontAlt/events_6431.csv'),'6431CorrectAlts',...
