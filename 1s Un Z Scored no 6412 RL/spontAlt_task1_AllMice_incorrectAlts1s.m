...
hold on
cdfplot(lme5xPlus{:,1});
title('5x+ vs 5x-: CDF for Left Turns ','FontSize',14)
...
title('5x+ vs 5x-:  Spike Rate Comparison for Left Turns','FontSize',20)
...
title(' Spike Rate Comparison Around Left Turns: All Mice Included','FontSize',24)
...
title('5x Plus')
title(t,'Left Turns ','FontSize',32,'FontWeight','Bold')
...
title(' Spike Rate Comparison for Left Turns','FontSize',20)
ylabel('Event Rate','FontSize',14)
