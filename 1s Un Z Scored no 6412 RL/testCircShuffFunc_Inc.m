...
spikeRateMatx6412 = circShuff(readtable('SpontAlt/events_6412_2nd.csv'),'6412IncorrectAlts',...
    times6412_2_inc,startFrame6412_2,28.29);

spikeRateMatx6416 = circShuff(readtable('SpontAlt/events_6416_2nd.csv'),'6416IncorrectAlts',...
    times6416_2_inc,startFrame6416_2,27.66);
