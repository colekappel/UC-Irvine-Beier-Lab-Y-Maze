...
writematrix(plusCircShuff,'plusCircShuff_cor.csv');
...
minusCircShuff = [circShuff6039; circShuff6041;circShuff6416;circShuff6417;circShuff6431;circShuff6412];

writematrix(minusCircShuff,'minusCircShuff_cor.csv');
...
lmeFormulaAmplitudePlusV_Minus = 'avAmplitudeForEachCell~plusOrMinus+(1|mouseID)';

lmePlusVMinus_Amplitude= fitlme(lmeAllMice,lmeFormulaAmplitudePlusV_Minus);
...
hold on
cdfplot(lme5xPlus{:,1});
title('5x+ vs 5x-: CDF for Correct Alternations ','FontSize',14)
...
title('5x+ vs 5x-:  Spike Rate Comparison for Correct Alternations ','FontSize',20)
...
title(' Spike Rate Comparison Around Correct Alternations: All Mice Included','FontSize',24)
...
title('5x Plus')
title(t,'Correct Alternations ','FontSize',32,'FontWeight','Bold')
...
title(' Spike Rate Comparison for Correct Alternations','FontSize',20)
ylabel('Event Rate','FontSize',14)
...
%% want to add the cell name column
...
save('responsivenessCorrect.mat','lme5xMinus','lme5xPlus')
